...
//    }
    ...
    cout << "\nMencari Buku:" << endl;
//    i = SequentialSearchBukuIterasi(rak, "Windows dan Linux");
//    i = SequentialSearchBukuIterasi(rak, "Resep Masak");
//    i = SequentialSearchBukuIterasi(rak, "Web Development");
//    i = SequentialSearchBukuIterasi(rak, "Max Haavelar");
